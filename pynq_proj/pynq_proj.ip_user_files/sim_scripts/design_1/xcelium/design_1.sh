...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../pynq_proj.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../pynq_proj.gen/sources_1/bd/design_1/ipshared/5765/hdl" \
       +incdir+"../../../../pynq_proj.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../pynq_proj.gen/sources_1/bd/design_1/ipshared/5765/hdl" \
       +incdir+"/home/krunoslav/Xilinx/Vivado/2022.1/data/xilinx_vip/include"
}
